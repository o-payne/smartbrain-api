...
var axios = require('clarifai/dist/node_modules/axios');
...
if (typeof window !== 'undefined' && !('Promise' in window)) {
  window.Promise = require('clarifai/dist/node_modules/promise');
}

if (typeof global !== 'undefined' && !('Promise' in global)) {
  global.Promise = require('clarifai/dist/node_modules/promise');
}
